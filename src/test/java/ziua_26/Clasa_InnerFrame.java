package ziua_26;/*
Cum utilizam si definim lucrul cu :  frames / iframes

driver.switchTo().frame(name/id)
driver.switchTo().frame(WedElement)
driver.switchTo().frame(index)

trecerea din frame in frame se face cu comanda:
driver.switchTo().defaultContent();

trecerea la inner frame se face cu comanda:
driver.switchTo().frame(0);
suntem in frame 3 o sa trecem la inner frame cu primul index - adica 0 - si este frame-ul la care ne raportam - primul din frame3
